          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center">
              <a
                ...
                className="btn btn-brand text-lg px-8 py-3 inline-flex items-center space-x-2"
              >
                <span>Preinscripción Online</span>
              ...
              <p className="text-sm text-gray-500 mt-2">
                Te redirigirá al sitio oficial del Ministerio de Educación de Córdoba
              </p>
            </div>
          </div>
        </Section>
