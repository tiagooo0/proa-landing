...
export const noticias = [
  {
  slug: "noche-de-los-lapices-2025",
  title: "Jornada por la Noche de los Lápices",
  date: "2025-09-15",
  excerpt:
    "Estudiantes de ciclo básico participaron de un taller en el marco del Día de la Noche de los Lápices, organizado por el Centro de Estudiantes con el acompañamiento de la UES.",
  content: `
    <p>El 15 de septiembre, en el marco del Día de la Noche de los Lápices que se conmemora el 16, estudiantes de ciclo básico participaron de un taller organizado por el Centro de Estudiantes, con materiales e insumos proporcionados por la UES.</p>
    
    <p>La actividad fue guiada por estudiantes de sexto año, integrantes del Centro de Estudiantes y también de la UES, quienes reflexionaron sobre los hechos ocurridos durante la dictadura, incluyendo lo sucedido en Córdoba, y la importancia de los derechos humanos y la memoria histórica.</p>
    
    <p>Además, se convocó a los estudiantes a sumarse a la marcha conmemorativa del día siguiente, reafirmando el compromiso con la memoria, la justicia y la democracia.</p>
  `,
},

  {
    slug: "feria-ciencias-tecnologia",
    title: "Feria de Ciencias y Tecnología 2025",
    date: "2025-08-31",
    excerpt:
    ...
    content: `
      <p>Con gran orgullo compartimos los resultados de la participación de nuestros estudiantes en la Feria Provincial de Ciencias y Tecnología 2025, donde obtuvieron destacados reconocimientos.</p>
      
      <p>Los proyectos presentados incluyeron:</p>
      
      <ul>
           <li><strong>Proyecto de Máscaras en Teatro:</strong> 6to año</li>
           <li><strong>Proyecto Revista CIT:</strong> 5to año</li>
           <li><strong>Proyecto de Biología:</strong> 1er año</li>
      </ul>
  ...
  {
  slug: "revista-proa-cit-quinto-ano-2024",
  title: "Revista ProA CIT: quinto año 2024",
  date: "2024-11-15",  
  excerpt:
    "Estudiantes de quinto año produjeron una revista con noticias de interés, reflejando sus visiones y aprendizajes colaborativos durante 2024.",
  content: `
    <p>Durante el año 2024, los estudiantes de quinto año lanzaron la <strong>Revista ProA CIT</strong>, una publicación colectiva en la que cada estudiante contribuyó con noticias que les resultaban relevantes, junto con una sección que reúne varias noticias de interés general.</p>
    
    <p>La revista busca fomentar la creatividad, el pensamiento crítico y la responsabilidad social, permitiendo que los alumnos elijan temas que les importan, investiguen, redacten y compartan sus producciones con toda la comunidad educativa.</p>
    
    <p>Además, se incluyen secciones especiales que abordan distintas áreas: cultura, tecnología, ciencias, y actualidad. Cada noticia refleja una mirada personal, pero también un compromiso con el aprendizaje colaborativo.</p>
    
    <p>Invitamos a toda la comunidad a leer la revista completa en línea, difundirla, y seguir acompañando estos espacios de participación estudiantil que enriquecen nuestra propuesta educativa.</p>
  `,
  image: "/RevisCIT.jpeg"
},
